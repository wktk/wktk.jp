...
航空通信士技能証明書を取得して、さらに有効な航空身体検査証明書を併せて持つことで、
無線通信を行う航空機乗組員 (コックピット・クルー) としての乗務が可能になる。

航空従事者資格のうち航空通信士だけは実技試験がなく、17 歳以上の人が学科試験合格と電波法の「航空無線通信士」の免許[^2] の
2 つを揃えると技能証明を受けることができる。したがって、航空従事者技能証明の中で一番取得しやすいと言ってよいだろう。

航空通信士は、機長 (正操縦士)、副操縦士、機関士、航空士、通信士の 5 人で飛行機を飛ばしていた時代の役職らしい。
この 5 つの役職を航空機乗組員と呼ぶが、現代の航空機では通常 2 人の操縦士で全ての操作ができるため、わざわざ通信士を乗せる必要がない。
...
練習許可書の有効期間は通常 1 年間のところ、身体検査証明書で申請すると身体検査証明書の有効期間内に
限られてしまうことを考えると、大した利点ではなさそう。
そうすると、国際民間航空条約の規定に基づいて設けられていて通用力のある割には、あまり使い道がない資格になっている。

実用上のメリットがあまりない一方で、自家用操縦士と併せて持つ場合にはデメリットにもなりえる。
自家用操縦士だけを取得している人の第二種航空身体検査証明の有効期間は年齢によって最大 5 年である。
しかし、航空通信士を持っていると「自家用操縦士だけ」から外れてしまうので、第二種身体検査証明の有効期間が 1 年になってしまうと思われる[^6]。
...
- 学科試験申請
  - 第 19 号様式 -- 1 部 (必須)
  - 指定窓付封筒 -- 2 枚 (必須)
  - 納付書 -- 1 部 (任意 -- [航空法施行規則 第 31 号様式] を A4 普通紙で印刷すれば済むはず)
  - 板紙封筒 -- 1 部 (任意 -- こちらから申請書を送る用の封筒。窓口持参なら不要。使用しなくても不備にはならないと思われる)
- 交付申請
  - 第 19 号の 2 様式 -- 1 部 (必須)
  - 指定窓付封筒 -- 1 枚 (必須)
  - 板紙封筒 -- 1 枚 (任意 -- 同上)
...
スケジュールや申請書類事務処理要領は [国土交通省の HP](https://www.mlit.go.jp/koku/koku_tk12_000005.html) に載っている。
要領を参照しながら申請の書類を用意していくことになる。
...
ちなみに、学科試験には科目合格制度があり、**合格通知の日から** 1 年以内に実施される学科試験では、申請すれば合格済みの科目を免除できる [^12]。
また、学科試験に全科目合格したときの交付申請の期限は、**学科試験を申請した日から** 2 年以内である [^13]。
...
交付の準備ができて、交付通知書と納付書が郵便で届いた。最寄りの金融機関で納付して郵送で受け取ることもできるが、
...
領収書を受け取って、そのまま上の階の東京航空局の窓口に交付通知書と領収書を持っていき、技能証明書を受け取った。
