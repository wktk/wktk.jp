...
ということだったので、その場で「個人」と書いて所属先の電話番号は空欄で提出した [^8] 。
...
動力車操縦者と同様に、いつか航空従事者技能証明を一般人が取得できるルートが消える可能性もなくもないかもしれない[^13]。
...
[^4]: 国土交通省航空局安全部運航安全課長通達「[航空機操縦練習許可申請要領]」より
...
[^9]: ツイートの問題は誤りを選択する問題で、(3) は「9 時間 __遅い__ 」⇒「9 時間 __早い__ 」の部分が誤りでこれが正答である。しかし、一般に UTC はグリニッジ天文台ではなく原子時計が基準なので (1) も誤りといえると考えた。ツイート内では GMT なら間違いないと書いたが、GMT もグリニッジ天文台からずれているので、この点でも誤りと考えることができる。ただ、日本の法令上はグリニッジ天文台の子午儀を本初子午線として定義しているらしい。これ以上はわからないので、「誤りでないとは言い切れない」と迂遠な表現をしている。
