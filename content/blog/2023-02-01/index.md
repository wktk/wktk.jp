...
- 郵送・窓口共通:
  ...
  - 本人確認書類
    - この手続きで利用できるのは「現住所・氏名が記載された」「法令に基づいて交付された」文書
...
請求書の 2 ページ目の説明も参照しながら、下記の例の赤字部分の要領で記入していく。
...
一方で、逆に請求が早すぎて差し支えるパターンもありうる。
試験日から合格発表の間に請求すると、採点や合格発表との兼ね合いで問題がある可能性が考えられる (未確認)。
